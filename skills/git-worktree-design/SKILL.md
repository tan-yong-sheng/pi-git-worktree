...
Present the **full plan** in a single code block (Table + Spec summaries for **all** branches). Request confirmation for the entire roadmap before initiating any operations.
